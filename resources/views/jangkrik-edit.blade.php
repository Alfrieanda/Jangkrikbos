                ...
                <div class="container-fluid">
                        ...
                        <form action="{{ route('jangkrik.update', $nan->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="keterangan" name="keterangan" class="form-control"
                                    value="{{ $nan->keterangan }}" placeholder="Keterangan">
                            </div>
                            <div class="form-group">
                    ...
                    <script>
                        function formatInput(input) {
                            ...
                            // Menghapus semua koma selain yang berada di antara angka
                            const formattedValue = cleanedValue.replace(/,+/g, ',');
                    
                            // Menampilkan formattedValue dengan prefix 'Rp'
